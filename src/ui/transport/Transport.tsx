...
export function Transport(props: Props) {
  return (
    <div className="transport" data-testid="transport">
      ...
      <div className="transport-group" data-group="marks">
      ...
      {props.onUndo || props.onRedo ? (
        <div className="transport-group" data-group="history">
          {props.onUndo ? (
      ...
      {props.onToggleSnap || props.onToggleShortcuts ? (
        <div className="transport-group" data-group="opts">
          {props.onToggleSnap ? (
            <button
              type="button"
