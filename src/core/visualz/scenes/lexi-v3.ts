/**
 * Scene: lexi-v3 — LEXI V3 Depth (PR #29 tip 0d0ee82).
 * Cinematic depth: vanishing terrain, pressure waves, musical form.
...
function resetLexiV3State(): void {
  phase = 0;
  lastTimeMs = -1;
  sRms = 0;
  sBass = 0;
...
export const lexiV3Scene: Scene = {
  id: "lexi-v3",
  name: "LEXI V3 Depth",
  description: "V3 cinematic depth — vanishing terrain, kick pressure, musical form",
  defaultParams: {
    intensity: 0.86,
