/**
 * Scene: lexi — AILEXSI flagship LEXI (reference-level cinematic energy space).
 * Dense particle-dune terrain, silk hero stream, FG/MG/BG atmosphere.
 * Canvas 2D V1 toward the attached CGI niveau — not a WebGL point-cloud.
...
export const LEXI_REF_DUNE_MERIDIANS = 58;
export const LEXI_REF_DUNE_CONTOURS = 14;
export const LEXI_REF_SURFACE_POINTS = 720;
export const LEXI_REF_MOUNTAIN_PEAKS = 9;
export const LEXI_REF_FG_BOKEH = 22;
...
export const lexiScene: Scene = {
  id: "lexi",
  name: "LEXI",
  description: "Reference-level cinematic energy space — particle dunes, silk stream, atmospheric depth",
  defaultParams: {
    intensity: 0.86,
