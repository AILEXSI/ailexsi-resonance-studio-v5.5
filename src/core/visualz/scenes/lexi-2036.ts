/**
 * Scene: lexi-2036 — LEXI 2036 (PR #30 tip 9553edf).
 * Cinematic future energy space: FG traces, MG terrain, hero stream, BG haze.
...
function resetLexi2036State(): void {
  phase = 0;
  lastTimeMs = -1;
  sRms = 0;
  sBass = 0;
...
export const lexi2036Scene: Scene = {
  id: "lexi-2036",
  name: "LEXI 2036",
