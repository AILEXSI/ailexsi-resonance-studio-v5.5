/**
 * Scene: lexi-v2 — LEXI Flow V2 / Polish (PR #28 tip 8d46dbf).
 * Distinct from LEXI Minimal Horizon (lexi-minimal): this is the original V2 flagship look.
...
type LexiThemeId = keyof typeof LEXI_THEMES;
const LEXI_DEFAULT_THEME: LexiThemeId = "gold";
...
function isLexiThemeId(value: string): value is LexiThemeId {
  return Object.prototype.hasOwnProperty.call(LEXI_THEMES, value);
}

function resolveLexiTheme(params: SceneParams): (typeof LEXI_THEMES)[LexiThemeId] {
...
function resetLexiV2State(): void {
  phase = 0;
  lastTimeMs = -1;
  sRms = 0;
  sBass = 0;
...
export const lexiV2Scene: Scene = {
  id: "lexi-v2",
  name: "LEXI Flow V2",
  description: "Polish V2 horizon flow — layered filaments, haze, receding sea",
  defaultParams: {
    intensity: 0.82,
