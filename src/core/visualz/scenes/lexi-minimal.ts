 ...
 * Calm parallel-horizon flow. Flagship LEXI is the reference-level energy space.
...
function resetLexiMinimalState(): void {
  phase = 0;
  lastTimeMs = -1;
  sRms = 0;
  sBass = 0;
...
export const lexiMinimalScene: Scene = {
  id: "lexi-minimal",
  name: "LEXI Minimal Horizon",
  description: "Quiet parallel-horizon flow — calm gold sea, the V2 look",
  defaultParams: {
    intensity: 0.82,
