...
**V5.5 production:** AILEXSI Frame Engine is the only export frame source. Mediabunny is removed. Preview HTMLVideo is unchanged. AFE-03 optimizations (streaming sequential path, ready queue, precomputed plan, prefetch 4) are kept.
