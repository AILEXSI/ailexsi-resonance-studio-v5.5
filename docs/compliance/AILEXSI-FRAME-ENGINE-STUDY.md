...
`npm run afe:bframe` → `docs/compliance/afe-04-evidence-summary.json`. Linux Chrome this pass: **620/620 EXACT** (0 wrong / ±1 / snap / substitution). jsdom cannot decode; Chrome / WebView2 can.
