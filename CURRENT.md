...
| Deps / SBOM | Mediabunny **removed**. CycloneDX SBOMs + inventory: `docs/compliance/`. MODE A AFE-04: tsc exit 0; vitest **985 tests passed in 118 files**; vite 7.3.6, 141 modules, version 5.5.0. Chrome B-frame pixels **620/620 EXACT** (`docs/compliance/afe-04-evidence-summary.json`). **No LICENSE. No THIRD_PARTY_NOTICES. Does not claim MPL FREE. Licensing is not HUMAN-PROVEN.** |
