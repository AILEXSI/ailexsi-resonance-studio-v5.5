...
| Deps / SBOM | Mediabunny **removed**. CycloneDX SBOMs + inventory: `docs/compliance/`. MODE A AFE-05: tsc exit 0; vitest **1005 tests passed in 121 files**; vite 7.3.6, 142 modules, version 5.5.0. Chrome B-frame pixels **1188/1188 EXACT** (`docs/compliance/afe-04-evidence-summary.json` + `afe-05-evidence-summary.json`). **No LICENSE. No THIRD_PARTY_NOTICES. Does not claim MPL FREE. Licensing is not HUMAN-PROVEN.** |
