...
| Deps / SBOM | Mediabunny **removed**. CycloneDX SBOMs + inventory: `docs/compliance/`. MODE A this bootstrap: tsc exit 0; vitest **953 tests passed in 112 files**; vite 7.3.6, 139 modules, version 5.5.0. **No LICENSE. No THIRD_PARTY_NOTICES. Does not claim MPL FREE. Licensing is not HUMAN-PROVEN.** |
